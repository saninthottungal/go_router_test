...
mixin _$ItemModel {
  ...
  ShopItems get itemType => throw _privateConstructorUsedError;
...
abstract class $ItemModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String uid, String title, ShopItems itemType});
}
...
class _$ItemModelImpl implements _ItemModel {
  const _$ItemModelImpl(
      {required this.uid, required this.title, required this.itemType});
  ...
  @override
  String toString() {
    return 'ItemModel(uid: $uid, title: $title, itemType: $itemType)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, uid, title, itemType);
...
abstract class _ItemModel implements ItemModel {
  const factory _ItemModel(
      ...
      required final ShopItems itemType}) = _$ItemModelImpl;
